...
const ApplicationDetails = () => {
    ...
    return (
        <div className="bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen flex flex-col font-body">
            {company && <CompanyNavbar company={company} />}
            {!company && (
                <header className="flex justify-between items-center px-6 h-16 w-full sticky top-0 z-50 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-none">
                    <span className="text-xl font-bold font-display text-primary">Stag.io</span>
                </header>
            )}

            <div className="flex flex-1">
                {/* SideNavBar */}
                <aside className="hidden md:flex flex-col w-64 p-4 bg-slate-50 dark:bg-slate-950 border-r border-slate-200 dark:border-slate-800 h-[calc(100vh-64px)] sticky top-16">
                    <div className="mb-8 px-4 flex flex-col items-center text-center mt-4">
                        ...
                        <h2 className="font-display font-semibold text-lg text-slate-900 dark:text-slate-100">{appData.name}</h2>
                        <p className="font-body text-xs text-slate-500 dark:text-slate-400">{appData.role}</p>
                    ...
                    <nav className="flex-1 flex flex-col gap-1">
                        {tabs.map(tab => (
                            <button
                                ...
                                className={`flex items-center gap-3 px-4 py-2 font-body text-sm rounded-lg transition-colors w-full ${activeTab === tab.id ? 'bg-indigo-50 dark:bg-indigo-900/30 text-primary font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-900'}`}
                            >
                    ...
                    <div className="max-w-[1200px] mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">Match Score</p>
                                    <p className="text-2xl font-bold font-display text-slate-900 dark:text-white">{appData.matchScore}%</p>
                                </div>
                            </div>
                            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">Days in Pipeline</p>
                                    <p className="text-2xl font-bold font-display text-slate-900 dark:text-white">4</p>
                                </div>
                            </div>
                            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl font-bold font-display text-slate-900 dark:text-white">{appData.status}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="lg:col-span-2 space-y-8">
                                ...
                                {activeTab === 'Overview' && (
                                    <>
                                        <section className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-all">
                                            <h3 className="font-display text-lg font-bold mb-4 flex items-center gap-2">
                                                <span className="material-symbols-outlined text-slate-400">mail</span>
                                                Cover Letter
                                            </h3>
                                            <div className="prose prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-400 leading-relaxed text-sm md:text-base">
                                            ...
                                            <div className="space-y-6">
                                                <div className="flex gap-4">
                                                    <div className="w-10 h-10 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center shrink-0">
                                                        <span className="material-symbols-outlined text-slate-500">corporate_fare</span>
                                                    </div>
                                                    <div>
                                                        <h4 className="font-bold text-slate-900 dark:text-white">UI/UX Design Intern @ Creative Co</h4>
                                                        <p className="text-xs text-slate-500 mb-2">Summer 2023 • Internship</p>
                                                        <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">Assisted in redesigning the core dashboard interface, resulting in a 20% improvement in user satisfaction metrics.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </section>
                                        ...
                                        <section className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-all">
                                            ...
                                            <div className="flex gap-4">
                                                ...
                                                <div>
                                                    <h4 className="font-bold text-slate-900 dark:text-white">B.Sc. in Human-Computer Interaction</h4>
                                                    <p className="text-xs text-slate-500">University of Technology • Expected 2025</p>
                                                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-2">Specializing in interactive systems and cognitive psychology.</p>
                                                </div>
                                            </div>
                                        </section>
                                    </>
                                ...
                                {activeTab === 'Timeline' && (
                                    <section className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-all h-full">
                                        <h3 className="font-display text-lg font-bold mb-6 flex items-center gap-2">
                                        ...
                                        <div className="relative pl-6 space-y-8 before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-[2px] before:bg-indigo-100 dark:before:bg-slate-800">
                                            <div className="relative">
                                                ...
                                                <h4 className="text-sm font-bold text-slate-900 dark:text-white">Screening Call Scheduled</h4>
                                                <p className="text-xs text-slate-500">Nov 22, 2023 • 2:00 PM</p>
                                            </div>
                                            <div className="relative">
                                                ...
                                                <h4 className="text-sm font-bold text-slate-700 dark:text-slate-300">Review Started</h4>
                                                <p className="text-xs text-slate-500">Nov 20, 2023 • 10:15 AM</p>
                                            </div>
                                            <div className="relative">
                                                <div className="absolute -left-[23px] top-1 w-3 h-3 rounded-full bg-indigo-400 ring-4 ring-indigo-50 dark:ring-indigo-900/40"></div>
                                                <h4 className="text-sm font-bold text-slate-700 dark:text-slate-300">Applied</h4>
                                                <p className="text-xs text-slate-500">Nov 18, 2023 • 4:30 PM</p>
                                            </div>
                                        </div>
                                    </section>
                                )}
                                ...
                                {activeTab === 'Documents' && (
                                    <section className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-all h-full">
                                        ...
                                        <div className="flex flex-col gap-4">
                                            <div className="border border-slate-200 dark:border-slate-700 p-4 rounded-xl flex items-center gap-4 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                                                <span className="material-symbols-outlined text-red-500 text-3xl">picture_as_pdf</span>
                                                <div className="flex-1">
                                                    <p className="font-bold text-sm text-slate-800 dark:text-slate-200">Resume.pdf</p>
                                                    <p className="text-xs text-slate-500">1.2 MB • Uploaded at application</p>
                                                </div>
                                            ...
                                            <div className="border border-slate-200 dark:border-slate-700 p-4 rounded-xl flex items-center gap-4 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                                                ...
                                                <div className="flex-1">
                                                    <p className="font-bold text-sm text-slate-800 dark:text-slate-200">Portfolio_Final.zip</p>
                                                    <p className="text-xs text-slate-500">24 MB • Uploaded at application</p>
                                                </div>
                                                <button className="material-symbols-outlined text-slate-400 hover:text-primary transition-colors">download</button>
                                            </div>
                                        </div>
                                ...
                                {activeTab === 'Interviews' && (
                                    <section className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-all flex flex-col items-center justify-center text-center h-full min-h-[300px]">
                                        ...
                                        <p className="text-slate-500 text-sm max-w-sm">When you configure the interview backend integration, upcoming and past video sessions will map here.</p>
                                    </section>
                                )}

                                {activeTab === 'Feedback' && (
                                    <section className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-all h-full min-h-[300px]">
                                        ...
                                        <p className="text-slate-500 text-sm mb-6">Collaborate with your team to review this candidate.</p>
                                        <div className="flex flex-col h-full min-h-[400px]">
                                            <div className="flex-1 bg-slate-50 dark:bg-slate-800/50 rounded-lg p-4 mb-4 border border-slate-100 dark:border-slate-800 overflow-y-auto max-h-[400px] flex flex-col gap-3">
                                                {feedbackList.length === 0 ? (
                                                    <div className="h-full flex items-center justify-center">
                                                        <p className="text-slate-400 text-sm italic">No feedback comments yet.</p>
                                                    </div>
                                                ) : (
                                                    feedbackList.map((fb, idx) => (
                                                        <div key={idx} className="bg-white dark:bg-slate-700 p-3 rounded-lg shadow-sm border border-slate-200 dark:border-slate-600 shrink-0">
                                                            <div className="flex justify-between items-start mb-1">
                                                                <span className="font-bold text-xs text-slate-800 dark:text-slate-200">{fb.authorName}</span>
                                                                <span className="text-[10px] text-slate-400">{moment(fb.createdAt).fromNow()}</span>
                                                            </div>
                                                            <p className="text-sm text-slate-600 dark:text-slate-300">{fb.text}</p>
                                                        </div>
                                                    ))
                                                )}
                                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <section className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
                                    <h3 className="font-display text-sm font-bold text-slate-500 uppercase tracking-wider mb-6">Quick Info</h3>
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-4">
                                            <span className="material-symbols-outlined text-slate-400 bg-slate-50 dark:bg-slate-800 p-2 rounded-lg">alternate_email</span>
                                            <div className="truncate">
                                                <p className="text-[10px] text-slate-400 uppercase font-bold">Email</p>
                                                <p className="text-sm font-medium text-slate-700 dark:text-slate-300">{appData.email}</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            <span className="material-symbols-outlined text-slate-400 bg-slate-50 dark:bg-slate-800 p-2 rounded-lg">call</span>
                                            <div>
                                                <p className="text-[10px] text-slate-400 uppercase font-bold">Phone</p>
                                                <p className="text-sm font-medium text-slate-700 dark:text-slate-300">{appData.phone}</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            <span className="material-symbols-outlined text-slate-400 bg-slate-50 dark:bg-slate-800 p-2 rounded-lg">account_balance</span>
                                            <div>
                                                <p className="text-[10px] text-slate-400 uppercase font-bold">University</p>
                                                <p className="text-sm font-medium text-slate-700 dark:text-slate-300">{appData.university}</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            <span className="material-symbols-outlined text-slate-400 bg-slate-50 dark:bg-slate-800 p-2 rounded-lg">link</span>
                                            <div>
                                                <p className="text-[10px] text-slate-400 uppercase font-bold">Social</p>
                                ...
                                {activeTab === 'Overview' && (
                                    <section className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-all hidden xl:block">
                                        <p className="text-xs text-center text-slate-400 italic">Navigate through sidebar tabs for deeper applicant insight.</p>
                                    </section>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 md:p-8 max-w-md w-full shadow-2xl border border-slate-200 dark:border-slate-800 animate-in zoom-in-95 duration-300">
                        <div className="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500 dark:text-slate-400 mt-2 leading-relaxed">
                                    Are you sure you want to mark <span className="font-semibold text-slate-700 dark:text-slate-300">{appData.name}</span>'s application as <span className="font-bold text-slate-800 dark:text-slate-200">&quot;{confirmationModal.status}&quot;</span>? This action can trigger automated emails and dashboard updates.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-end gap-3 mt-8 pt-6 border-t border-slate-100 dark:border-slate-800/60">
                            <button
                                ...
                                disabled={actionLoading}
                                className="px-5 py-2.5 rounded-xl font-bold text-sm text-slate-600 hover:text-slate-900 hover:bg-slate-100 dark:text-slate-400 dark:hover:text-white dark:hover:bg-slate-800 transition-colors disabled:opacity-50"
                            >
                                Cancel
                            </button>
                            <button
